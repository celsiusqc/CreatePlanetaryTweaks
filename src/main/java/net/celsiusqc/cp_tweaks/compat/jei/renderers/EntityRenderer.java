package net.celsiusqc.cp_tweaks.compat.jei.renderers;
            ...
            if (level != null && !IGNORED_ENTITIES.contains(type)) {
                ...
                if (entity instanceof LivingEntity livingEntity) {
                    ...
                    try {
                        ...
                        CreatePlanetaryTweaks.LOGGER.error("Error drawing entity " + ForgeRegistries.ENTITY_TYPES.getKey(type), e);
