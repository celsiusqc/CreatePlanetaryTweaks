package net.celsiusqc.cp_tweaks.entity.client.renderer.entity;
...
public class StarviewerGiantRenderer <T extends GiantMiner> extends MobRenderer<T, PlayerModel<T>> {
    private final PlayerModel<T> normalModel;
    private final PlayerModel<T> slimModel;

    public StarviewerGiantRenderer(EntityRendererProvider.Context context) {
