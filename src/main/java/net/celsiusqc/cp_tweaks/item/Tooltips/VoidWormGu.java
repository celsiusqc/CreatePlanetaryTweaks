...
public class VoidWormGu extends Item {
    public VoidWormGu(Properties pProperties) {
        super(pProperties);
    }
    ...
    public void appendHoverText(@NotNull ItemStack stack, @Nullable Level level, @NotNull List<Component> components, @NotNull TooltipFlag flag) {
        ...
        components.add(Component.literal("This item is obtained by Killing the Void Worm Boss from the Alex's Mobs mod.").withStyle(ChatFormatting.YELLOW));
