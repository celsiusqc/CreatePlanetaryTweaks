...
public class EnderGuardianGu extends Item {
    public EnderGuardianGu(Properties pProperties) {
        super(pProperties);
    }
    ...
    public void appendHoverText(@NotNull ItemStack stack, @Nullable Level level, @NotNull List<Component> components, @NotNull TooltipFlag flag) {
        ...
        components.add(Component.literal("This item is obtained by Killing the Ender Guardian Boss from the Cataclysm mod.").withStyle(ChatFormatting.YELLOW));
